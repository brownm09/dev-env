...
- **Tiles:** each spawned tile is its own shard `sessions/<project>/tiles/<issue-number>.json`, keyed by
  ...
  rationale, and why a headless process *cannot* respawn tiles instead, in [ADR-116](../docs/adr/116-tile-persistence-shards.md).

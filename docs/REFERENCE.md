...
- **An empty package directory is usually fine.** npm creates one for every `optionalDependencies`
  ...
  `@rollup/<platform>` directories — up to 21% of all package directories. Only the *matching*

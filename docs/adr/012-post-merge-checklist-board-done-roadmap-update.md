...
**Motivating incident:** lifting-logbook v0.1 and v0.2 shipped without corresponding ROADMAP.md updates ([lifting-logbook#97](https://github.com/merickvaughn/lifting-logbook/issues/97)). The roadmap became misleading rather than informative.

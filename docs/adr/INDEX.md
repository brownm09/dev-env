...
| [040](040-project-specific-rules-belong-in-project-claude.md) | Project-Specific Rules Belong in the Project `CLAUDE.md` | 2026-06-06 | Accepted | claude, layering, documentation, global-rule, project-rule, dev-env |
